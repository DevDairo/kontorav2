...
export const appRoutes: AppRoute[] = [
  ...
  },
  {
    ...
    roleDescriptions: {
      ...
      administrador: "Consulta la operacion y administra evidencias de gastos y deposito.",
      gerente: "Consulta la operacion y administra evidencias de gastos y deposito.",
    },
    roleEndpoints: {
      vendedor: [
        "GET /api/consultas/ventas",
